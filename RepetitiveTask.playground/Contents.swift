...
//: Definition of FailableTransientURLTask.
...
let task = FailableTransientURLTask(session: failableSession, url: NSURL(string: "http://blog.krzyzanowskim.com/rss")!, parameters: ["foo": "bar"])
